...
- **Анонимизация текста** (PII removal) - удаление персональных данных через Python сервис с Natasha NER
...
- **Python Anonymizer Service** (Natasha NER + EasyOCR)
- Axios для HTTP вызовов

## Основные операции

### Анонимизация (PII Removal)
- Обнаружение и замена через Natasha NER + regex:
  - ФИО
  - Адреса  
  - Номера телефонов
  - Email адреса
