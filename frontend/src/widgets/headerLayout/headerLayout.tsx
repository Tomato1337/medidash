				...
				<div className="flex items-center justify-center gap-4 pt-4">
					...
					{isDashboard &&
						(isLoading && !data ? (
							...
							<Avatar className="size-12 cursor-pointer border transition-transform duration-200 hover:scale-105 motion-reduce:transform-none" aria-label="Профиль пользователя">
								<AvatarImage />
