import { db, type IDBRecord, type IDBDocument } from "../lib/indexedDB"
import { client } from "../api/api"
import { getCompressionWorkerManager } from "../lib/compressionWorkerManager"
import {
	DocumentStatus,
	FailedPhase,
...
export class SyncManager {
	...
	private async uploadDocument(
		...
		try {
			...
			const { uploadUrl, documentId } = urlRes.data as {
				uploadUrl: string
				documentId: string
			}
